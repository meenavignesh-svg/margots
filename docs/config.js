...
/* Premium MARGOTS visual system. */
(() => {
  const css = document.createElement('link');
  css.rel = 'stylesheet';
  css.href = 'ui-polish.css?v=10';
  ...
  style.textContent = `
    ...
    .dna .tube.a{stroke:url(#tubeA)} .dna .tube.b{stroke:url(#tubeB)}
    .dna .shine{fill:none;stroke:rgba(255,255,255,.72);stroke-width:5;stroke-linecap:round;opacity:.72}.dna .shine.b{opacity:.5}
    ...
    @media(max-width:1000px){.dna{width:410px;height:430px}}@media(max-width:800px){.dna-stage{height:350px}.dna{width:330px;height:350px}.dna-stage:before{inset:0}}
    @media(prefers-reduced-motion:reduce){.dna .margots-helix,.dna-stage:before{animation:none!important}}
  `;
  document.head.appendChild(style);

  function mount(){
    const root=document.querySelector('.dna'); if(!root)return;
    root.innerHTML=`<svg class="margots-helix" viewBox="0 0 500 510" role="img" aria-label="Abstract glossy molecular helix">
      <defs>
        <linearGradient id="tubeA" x1="80" y1="0" x2="410" y2="510" gradientUnits="userSpaceOnUse"><stop stop-color="#dffcff"/><stop offset=".14" stop-color="#55c9f1"/><stop offset=".38" stop-color="#3978ea"/><stop offset=".58" stop-color="#766aff"/><stop offset=".8" stop-color="#3acbdc"/><stop offset="1" stop-color="#c9f5ff"/></linearGradient>
        <linearGradient id="tubeB" x1="410" y1="0" x2="80" y2="510" gradientUnits="userSpaceOnUse"><stop stop-color="#eee7ff"/><stop offset=".16" stop-color="#8764f5"/><stop offset=".38" stop-color="#438de9"/><stop offset=".6" stop-color="#a16bf2"/><stop offset=".82" stop-color="#52d3e3"/><stop offset="1" stop-color="#eee8ff"/></linearGradient>
      ...
      <ellipse class="orbit" cx="250" cy="255" rx="215" ry="125" transform="rotate(-22 250 255)"/><ellipse class="orbit" cx="250" cy="255" rx="185" ry="72" transform="rotate(30 250 255)" opacity=".55"/>
      ...
      <path class="shine" d="M118 18 C396 70 396 137 126 188 C-140 239 -140 309 126 360"/><path class="shine b" d="M382 18 C104 70 104 137 374 188 C640 239 640 309 374 360"/>
      <path class="shine" d="M126 370 C390 418 394 451 350 484"/><path class="shine b" d="M374 370 C110 418 106 451 150 484"/>
      <g><circle class="molecule" fill="url(#blueSphere)" cx="82" cy="82" r="19"/><circle class="molecule" fill="url(#purpleSphere)" cx="425" cy="112" r="15"/><circle class="molecule" fill="url(#cyanSphere)" cx="63" cy="304" r="12"/><circle class="molecule" fill="url(#purpleSphere)" cx="426" cy="339" r="21"/><circle class="molecule" fill="url(#blueSphere)" cx="403" cy="48" r="8"/><circle class="molecule" fill="url(#cyanSphere)" cx="92" cy="417" r="7"/><circle class="molecule" fill="url(#purpleSphere)" cx="453" cy="216" r="7"/><circle class="molecule" fill="url(#cyanSphere)" cx="43" cy="220" r="6"/><circle class="molecule" fill="url(#blueSphere)" cx="103" cy="150" r="6"/><circle class="molecule" fill="url(#purpleSphere)" cx="393" cy="278" r="6"/></g>
...
(() => {
  const load = () => { if(window.MARGOTSModules)return; const s=document.createElement('script'); s.src='frontend-modules.js?v=live'; s.defer=true; document.head.appendChild(s); };
